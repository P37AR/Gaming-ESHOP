...
import mk.ukim.finki.wp.eshop.model.exceptions.DiscountNotFoundException;
import mk.ukim.finki.wp.eshop.model.exceptions.UserNotFoundException;
import mk.ukim.finki.wp.eshop.repository.DiscountRepository;
import mk.ukim.finki.wp.eshop.repository.UserRepository;
import mk.ukim.finki.wp.eshop.service.DiscountService;
...
public class DiscountServiceImpl implements DiscountService {
    ...
    @Override
    public Page<Discount> findAllWithPagination(java.awt.print.Pageable pageable) {
        return this.discountRepository.findAll((Pageable) pageable);
    }
